...
**22 colouring pages.** Cover is separate. If you publish on Amazon KDP, add 2 blank "draw here" pages at the back to hit the 24-page minimum.

One page per build. No Plan / Build / Done. At this length, that recipe ate the book.
...
Kody full-body, hard hat, tool belt, hammer up, thumbs up. Colour the hat yellow.
...
Each page: Kody building it, object big enough to colour, safety glasses on. One action. Finished enough that a kid can tell what it is.

| Page | Build | Caption | Visual |
| --- | --- | --- | --- |
| 9 | Birdhouse | "Kody builds a birdhouse." | Half-built or just-finished birdhouse. One simple bird OK. |
| 10 | Planter | "A box for dirt and flowers." | Planter with a dirt mound and one flower. |
| 11 | Stool | "Four legs. One seat." | Kody sitting on the new stool, feet dangling. |
...
### Page 20 — Pegboard
**Visual:** Pegboard now full. Every intro tool in its outline. Quiet find-the-tool page.
...
### Pages 23 to 24 (KDP only)
Blank frames. Caption: "Draw your build here."
...
15. A house for a dog.
16. A table for outside.
17. Cold lemonade! Come and get it!
18. Kody built a fort!
...
| Old page | Fate |
| --- | --- |
| Screwdriver solo | Lives on the belt page |
| Drill solo | Sits on the bench on the belt page, or on the safety page as the reason for ear muffs |
