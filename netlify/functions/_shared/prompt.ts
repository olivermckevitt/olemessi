...
Analyze the Whisper Flow transcript. Pick one primary folder. Do not split the note.
...
- daily_log_summary: 1-2 sentences summarizing the dictation.
...
Red flags:
- If a Retail Construction Skill Base is included below, compare the transcript against it only. Do not use outside codes or invented rules.
...
export function classifyUserMessage(text: string, skillBase: string | null): string {
